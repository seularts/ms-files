...
**Venue**: F5 Networks Singapore Pte Ltd, 5 Temasek Boulevard,
...
![AISP_15Jan2025_logo](assets/images/AISP_15Jan2025.png)
...
We have a distinguished speaker lined up: James Lee from F5. The topics
...
As the venue is in F5 office, for corporate security reasons, please
...
To help you design and build (more) security software in the future,
...
Security, is a static code analysis tool that is built for developers
...
The conference will start off with 2 heavyweight keynote speakers ---
...
He spoke at international conferences such as Defcon USA and Bsides
...
• Experience building, leading and coaching technical teams in the area
of new technologies.
...
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`(TSCM)`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`–`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
...
#### Jul 2013 Meetup: Managing Web & Application Security with OWASP -- bringing it all together {#jul-2013-meetup-managing-web--application-security-with-owasp--bringing-it-all-together}
...
#### Nov 2012 Meetup: AISP-OWASP: New web attacks & short intro on IT Impact of SG data privacy law {#nov-2012-meetup-aisp-owasp-new-web-attacks--short-intro-on-it-impact-of-sg-data-privacy-law}
...
cfemail="ed9e888e9f88998c9f848c99ad8c849e9dc39e8a"} latest by 16 Sep
2012.
...
Please RSVP to
[\[email protected\]](../cdn-cgi/l/email-protection.html){.__cf_email__
cfemail="dcafb9bfaeb9a8bdaeb5bda89cbdb5afacf2afbb"} latest by 10 Sep
2012.
...
\@planetbeing and joined by non other than Charlie \@0xcharlie Miller
and Stefan \@i0n1c Esser!
...
free complimentary passes before. Contact me @
[\[email protected\]](../cdn-cgi/l/email-protection.html){.__cf_email__
cfemail="bed1ddc9d1d0d9fed1c9dfcdce90d1ccd9"} if you want one of the
...
Contact me @
[\[email protected\]](../cdn-cgi/l/email-protection.html){.__cf_email__
cfemail="fd929e8a92939abd928a9c8e8dd3928f9a"} if you want the one of the
complimentary delegate passes.

For other members, you too can enjoy discounted affiliate rates when you
register.

[Click here to know more about Information Security Seminar
2011](http://www.aisp.org.sg/iss2011/)
...
Contact me @
[\[email protected\]](../cdn-cgi/l/email-protection.html){.__cf_email__
cfemail="a7c8c4d0c8c9c0e7c8d0c6d4d789c8d5c0"} if you want the one of the
complimentary delegate passes.
...
**`OWASP`{.language-plaintext .highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Moves`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`to`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`MediaWiki`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Portal`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`-`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`11:31,`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`20`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`May`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`2006`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`(EDT)`{.language-plaintext .highlighter-rouge}**
...
The chapter leader is [Onn
Chee](../cdn-cgi/l/email-protection.html#315e52465e5f56715e465042411f5e4356).
...
Email:
[\[email protected\]](../cdn-cgi/l/email-protection.html){.__cf_email__
cfemail="cea1adb9a1a0a98ea1b9afbdbee0a1bca9"}

**`OWASP`{.language-plaintext .highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Singapore`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`have`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`combined`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`its`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`activities`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`with`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Singapore`{.language-plaintext
...
.highlighter-rouge}`Security`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Meetup`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Group`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`(SSMG)`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`since`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Dec`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`2007`{.language-plaintext .highlighter-rouge}**
...
.highlighter-rouge}`Singapore`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Get`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Together`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`on`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`19:30,`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`9`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Oct`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`2007`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`(SGT)`{.language-plaintext .highlighter-rouge}**
...
.highlighter-rouge}`Singapore`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Nov`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
...
.highlighter-rouge}`19:30,`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`13`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Dec`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`2007`{.language-plaintext
...
.highlighter-rouge}`Singapore`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Jan`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Chapter`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Meeting`{.language-plaintext
...
.highlighter-rouge}`19:30,`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`10`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Jan`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`2008`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`(SGT)`{.language-plaintext .highlighter-rouge}**
...
.highlighter-rouge}`Singapore`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Feb`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Chapter`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Meeting`{.language-plaintext
...
.highlighter-rouge}`19:30,`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`14`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Feb`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`2008`{.language-plaintext
...
.highlighter-rouge}`13`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Mar`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`2008`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`(SGT)`{.language-plaintext .highlighter-rouge}**
...
.highlighter-rouge}`Singapore`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Apr`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Chapter`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`Meeting`{.language-plaintext
...
.highlighter-rouge}`19:30,`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`29`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`May`{.language-plaintext
.highlighter-rouge}` `{.language-plaintext
.highlighter-rouge}`2008`{.language-plaintext
...
::: github-buttons
[Watch](https://github.com/owasp/www-chapter-singapore/subscription){.github-button
icon="octicon-eye" data-size="large" show-count="true"
aria-label="Watch on GitHub"}
[Star](https://github.com/owasp/www-chapter-singapore){.github-button
...
- [Wong Onn
  Chee](../cdn-cgi/l/email-protection.html#a8c7cbdfc7c6cfe8c7dfc9dbd886c7dacf)
- [Cecil
  Su](../cdn-cgi/l/email-protection.html#e28187818b8ecc9197a28d95839192cc8d9085)
